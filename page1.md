...
<head><!--en tête de la pâge-->
	<title>Introduction au web : page1</title><!--en tête de la page-->
	<meta charset="utf-8"><!--encodage de la page (gestion des caractères accentués)-->
</head>
<body>
<!--corp de la page: contient les éléments affichés-->
<!-- <pre><pre/>  permet de respecter la mise en page dans l'éditeur de texte-->
<!--<p></p> faire des paragraphe-->	
<h1 id="haut">Introduction sur les balises, gestion du texete</h1>
<a title="Je suis le titre" href="#Poeme3">Aller au poème 3</a>
<h2>Balises paragraphe et saut de ligne</h2>
<a href="mailto:guillaumeedel19@gmail.com">Envoyer un mail</a>
<a href="../images/1064455.png">Telecharger l'image</a>
<p>	
Jean de LA FONTAINE<br/><br/>

1621 - 1695<br/>
La Laitière et le Pot au lait <br/>
...
Achetait un cent d'oeufs, faisait triple couvée ;<br/>
La chose allait à bien par son soin diligent.<br/>
Il m'est, disait-elle, facile,<br/>
D'élever des poulets autour de ma maison :<br/>
...
Il était quand je l'eus de grosseur raisonnable :<br/>
...
Tous les honneurs, toutes les femmes.<br/>
Quand je suis seul, je fais au plus brave un défi ;<br/>
Je m'écarte, je vais détrôner le Sophi ;<br/>
On m'élit roi, mon peuple m'aime ;<br/>
Les diadèmes vont sur ma tête pleuvant :<br/>
Quelque accident fait-il que je rentre en moi-même ;<br/>
...
<h5>Jean de LA FONTAINE</h5>
<h6>Jean de LA FONTAINE</h6>	
1621 - 1695<br/>
La Laitière et le Pot au lait <br/>
Perrette sur sa tête ayant un Pot au lait<br/>
Bien posé sur un coussinet,<br/>
...
<h2>Mise en avant de texte</h2>
<p>
<h3 id="Poeme3">Jean de LA FONTAINE</h3>
<!--balise <EM> a pour effet de mettre en italique le texte concerner-->
<!--balise <strong> permet de mettre en gras-->
<!--balise <mark> permet de surligner-->		
1621 - 1695<br/>
<em>La Laitière et le Pot au lait<br/>
Perrette sur sa tête ayant un Pot au lait<br/>
Bien posé sur un coussinet,<br/>
<mark>Prétendait arriver sans encombre à la ville.<br/>
Légère et court vêtue elle allait à grands pas ;<br/>
Ayant mis ce jour-là, pour être plus agile,</mark><br/>
Cotillon simple, et souliers plats.<br/>
Notre laitière ainsi troussée<br/>
Comptait déjà dans sa pensée<br/>
<em><strong><mark>Tout le prix de son lait, en employait l'argent,<br/></em></mark></srtong>
Achetait un cent d'oeufs, faisait triple couvée ;<br/>
La chose allait à bien par son soin diligent.<br/>
Il m'est, disait-elle, facile,<br/>
D'élever des poulets autour de ma maison :<br/>
...
J'aurai le revendant de l'argent bel et bon.<br/>
Et qui m'empêchera de mettre en notre étable,<br/>
<strong>Vu le prix dont il est, une vache et son veau,<br/>
Que je verrai sauter au milieu du troupeau ?</strong><br/>
Perrette là-dessus saute aussi, transportée.<br/>
Le lait tombe ; adieu veau, vache, cochon, couvée ;<br/>
La dame de ces biens, quittant d'un oeil marri<br/>
Sa fortune ainsi répandue,<br/>
...
En grand danger d'être battue.<br/>
Le récit en farce en fut fait ;<br/>
On l'appela le Pot au lait.</em><br/>
...
<h2>Mise en forme du texte sous forme de listes</h2>
<p>liste a puces des balises de mise en valeur du texte</p>
<ul><!--unordered liste-->
	<li>em</li>
	<li>strong</li>
	<li>mark</li>
</ul>
<p>liste ordonnées des balises de mise en valeur du texte</p>
<ol><!--ordered liste-->
	<li>em</li>
	<li>strong</li>
	<li>mark</li>
...
<!--Liste de mes équipement par hobby-->
<ol><!--liste des sports-->	
	<li>Volley-balle<!--premiere acitivité-->
		<ul>
			<li>.balle</li> 
			<li>.Vêtement(short-tee-shirt)</li>
			<li>.genouillère</li>
			<li>.Chaussure 
		</ul>
	<li>Boxe
	...
	<li>Natation
			...
			<li>.Lunette de plonger</li>
			<li>.Bonnet de bain </li>
</ol>
<a href="./index.html">lien vers l'accueil</a><!--lien fichier local-->
<!--".." permet de sortir d'un reperotire "." permet de dire quon est dans le repertoire courant et le "/" permet de niviguer-->
